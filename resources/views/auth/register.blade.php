...
<head>
  ...
  <title>Inscription - Account Management</title>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-12">
                        ...
                        <input type="password" name="password_confirmation" class="form-control" min="8" id="password_confirmation" required>  
                    ...
                    <div class="col-12">
                        <p class="small mb-0">Avez-vous un compte ? <a href="{{ route('login') }}">Se connecter</a></p>
                      </div>
                  </form>
